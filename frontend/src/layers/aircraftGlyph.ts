// Type-aware aircraft glyphs: widebodies tower over regional jets, four-engine
// heavies, turboprops and GA spin their props, and helicopters spin their
// rotors. Classification is from the ICAO type code with emitter-category
// fallbacks. The glyph is drawn in local space with -y as the direction of
// travel; the caller translates to the position and rotates to the heading.
//
// Ported from Skylight (https://github.com/cpaczek/skylight),
// web/src/display/aircraftGlyph.ts — MIT License, Copyright (c) 2026 cpaczek.

export type GlyphAircraft = {
  typeCode?: string;
  category?: string;
};
...
export function classifyGlyph(ac: GlyphAircraft): GlyphKind {
